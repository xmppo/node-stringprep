{
  'variables': {
    'module_name': 'node_stringprep',#Specify the module name here
  ...
  'targets': [
    {
        ...
        [ 'OS=="win"', {
		  ...
		  #we need to link to the node.lib and icuuc.lib files
          'libraries': [ '-l<(NODE_ROOT)/<(node_lib_folder)/node.lib','-l<(ICU_root)/lib/icuuc.lib'  ],
